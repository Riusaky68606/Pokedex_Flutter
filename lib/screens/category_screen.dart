...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  @override //metodo que se muestra antes de iniciar el widget, siver para inisializar cosas
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Tipod de Pokemon"),
      ),
      body: Column(
        children: [
          Padding(
            ...
            child: SizedBox(
              width: double
                  .infinity, //ocupa todo el espacio disponible en canto al ancho
              height: 40,
              child: Card(
                  elevation: 10.0,
                  child: Text("Ultima sincronización: $lastUpdate")),
            ),
          ),
        ...
        onPressed: () {
          ...
          setState(() {
            lastUpdate = DateTime.now()
                .toIso8601String(); //estandar para representacion de fechas y horas en texto
